...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-950 text-slate-900 dark:text-white selection:bg-emerald-500 selection:text-white">
      {/* Background Glows */}
      ...
      {/* Top Navbar */}
      <header className="relative z-10 border-b border-slate-100 dark:border-slate-800/80 bg-white/70 dark:bg-slate-950/70 backdrop-blur-md">
          ...
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <span className="hidden sm:block text-[11px] font-medium text-slate-500 dark:text-slate-400">
                AI Guidance for Pakistani Aspirants
              </span>
            </div>
          </Link>
      ...
      <section className="relative z-10 pt-16 pb-20 md:pt-24 md:pb-28">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50/80 px-4 py-1.5 text-xs font-semibold text-emerald-800 dark:border-emerald-800/80 dark:bg-emerald-950/50 dark:text-emerald-300 shadow-sm mb-6 animate-fade-in">
            <Sparkles className="h-3.5 w-3.5 text-emerald-600 dark:text-emerald-400" />
            <span>{t('badge', 'Designed for Pakistani Students (BS / MS / PhD / Postdoc)')}</span>
          </div>

          {/* Hero Headline */}
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-white leading-[1.15] max-w-4xl mx-auto">
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/dashboard" className="w-full sm:w-auto">
              <Button size="lg" variant="gradient" className="w-full gap-2 shadow-xl shadow-emerald-600/20">
          ...
          <div className="mt-12 inline-flex flex-col sm:flex-row items-center gap-3 rounded-2xl border border-amber-200/80 bg-amber-50/60 p-4 text-left dark:border-amber-900/60 dark:bg-amber-950/30 text-xs sm:text-sm text-slate-700 dark:text-slate-300 max-w-3xl mx-auto shadow-sm">
      ...
      {/* Stats Ribbon */}
      <section className="relative z-10 border-y border-slate-100 dark:border-slate-800 bg-slate-50/70 dark:bg-slate-900/50 py-10">
      ...
      <section className="relative z-10 py-20 md:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Feature 1 */}
            <div className="rounded-3xl border border-slate-200/80 bg-white p-7 shadow-sm transition-all hover:shadow-md hover:border-emerald-200 dark:border-slate-800 dark:bg-slate-900 flex flex-col justify-between">
              <div>
            ...
            <div className="rounded-3xl border border-slate-200/80 bg-white p-7 shadow-sm transition-all hover:shadow-md hover:border-emerald-200 dark:border-slate-800 dark:bg-slate-900 flex flex-col justify-between">
              <div>
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-teal-50 text-teal-600 dark:bg-teal-950/60 dark:text-teal-400 mb-5">
            ...
            <div className="rounded-3xl border border-slate-200/80 bg-white p-7 shadow-sm transition-all hover:shadow-md hover:border-emerald-200 dark:border-slate-800 dark:bg-slate-900 flex flex-col justify-between">
              <div>
                <div className="flex h-12 w-12 items-center justify-center rounded-2xl bg-indigo-50 text-indigo-600 dark:bg-indigo-950/60 dark:text-indigo-400 mb-5">
        ...
        <div className="rounded-3xl bg-gradient-to-r from-emerald-700 via-teal-700 to-indigo-800 p-8 sm:p-14 text-white shadow-2xl text-center relative overflow-hidden">
          <div className="relative z-10 max-w-2xl mx-auto">
            <h2 className="text-3xl sm:text-4xl font-black tracking-tight">
              Ready to Plan Your Foreign Education?
            </h2>
            <p className="mt-4 text-emerald-100 text-base sm:text-lg">
              Ask your first question now. Free, instant, and customized for Pakistani degrees.
            </p>
            <div className="mt-8 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/dashboard" className="w-full sm:w-auto">
                <Button size="lg" className="w-full bg-white text-emerald-900 hover:bg-slate-100 font-bold">
      ...
      {/* Footer */}
      <footer className="relative z-10 border-t border-slate-200 dark:border-slate-800 py-10 text-center text-xs text-slate-500 dark:text-slate-400">
        <div className="max-w-7xl mx-auto px-4 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div>
            © {new Date().getFullYear()} Study Abroad Advisor. Open source & free for Pakistani students worldwide.
          </div>
          <div className="flex items-center gap-6">
            ...
            <Link href="https://github.com/AbdulAzeemHashmi/study-abroad-advisor" target="_blank" className="hover:underline">
              GitHub Repository
            </Link>
          </div>
        </div>
